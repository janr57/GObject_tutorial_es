...
\begin{enumerate}
  \tightlist
\item Utilizar {\sffamily GObject} en los programas en C.
...
\subsection{Creación de instancias de {\sffamily GObject}} \label{subsec:creacion_instancias_gobject}
Para crear una instancia de {\sffamily GObject} se utiliza la función
