...
\subsubsection{Teoría}
\textsf{GObject} es un objeto base. Es muy simple y no se puede hacer mucho con él, excepto para crear
otras clases derivadas de \textsf{GObject} e instanciar nuevos tipos de objetos.
