...
Desde hace mucho, tuve interés en programar aplicaciones con la API de \textsf{GTK}.
...
Además proporciona la clase base, a partir de la que se construye el resto de los elementos de \textsf{GTK}.
