...
la instancia está referida (\emph{referred}), y se le asigna una cuenta de referencia (\textit{reference count}), haciendo la variable \texttt{ref\_count}) igual a 1, indicando que hay un módulo, función u objeto que la esta utilizando. Llamemos \textbf{A} a este elemento.
