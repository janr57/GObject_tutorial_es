...
\item Línea 9:\par
  ...
  \passthrough{\lstinline!t\_doble\_get\_type!}, que se definirá más adelante.
  Se necesitará definir la función anterior porque vamos a registrar la clase \textsf{T\_Doble\_Class} y
  el objeto \textsf{T\_Doble} manualmente. utilizando esta función, que a su vez, ejecuta
  \passthrough{\lstinline!g\_type\_register\_static!}. Aquí lo haremos manualmente en las líneas
  30--49. Pero normalmente el sistema de tipos generará unas macros automáticamente que
  se encargarán de esa definición.
...
\item Líneas 30--49:\par
  ...
  \textsf{TDoble}. Esta función es la que sustituye a la macro \texttt{T\_TYPE\_DOBLE} definida en la línea 9.
